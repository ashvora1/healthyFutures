...
function offlinetest( ) {
	...
	function handleCacheError( e ) {
		emis.mobile.console.error( e.type + 'Error: handleCacheError called. It is OK if this is called in OFFLINE mode. If this is called while online something is wrong.' );
	};
